...
class ProjectController extends Controller
{
    ...
    public function getProjectsAction(ParamFetcherInterface $paramFetcher)
    {
        ...
        $query->select(array('p'))
            ->from('AppClientBundle:ClientProject', 'p')
        ;
     ...
     *
     */
    public function getProjectAction($article, Request $request)
    {
        $query = explode('/', $request->getUri());
        $id = end($query);
        $data = $this->getDoctrine()->getRepository('AppClientBundle:ClientProject')->findOneBy(['id' => $id]);
    ...
    {
        return $this->createForm(new \App\ClientBundle\Form\ClientProjectType(), $article);
    }
    ...
    public function putProjectsAction(Request $request, $id)
    {
        ...
        $initial = $this->getDoctrine()->getRepository('AppClientBundle:ClientProject')->findOneBy(['id' => $id]);
        if(!is_null($initial))
        {
    ...
    public function deleteProjectAction($id)
    {
        ...
        $project = $this->getDoctrine()->getRepository('AppClientBundle:ClientProject')->findOneBy(['id' => $id]);
