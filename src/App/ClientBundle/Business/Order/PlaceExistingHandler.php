...
class PlaceExistingHandler extends AdminBusiness\Base\BaseCreateHandler
{
    public $product = null;
    ...
    public function buildForm($builder)
    {
        ...
        $builder->add('placeExisting', 'hidden');
    ...
    public function onSuccess()
    {
        ...
        // Create client
        $client   = $this->container->get('doctrine')->getRepository('AppUserBundle:User')->findOneByEmail($model->email);
